...
#define LPSPI_IP_SA_SW_MAJOR_VERSION_PBCFG_C                 6
...
static Lpspi_Ip_DeviceParamsType Lpspi_Ip_DeviceParamsCfg[3U] =
{
    {
        (uint8)8U, /* Frame size */
        (boolean)FALSE, /*Lsb */
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_2 =
{
    ...
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
        ...
        (uint32)(LPSPI_CCR_SCKPCS(5U) | LPSPI_CCR_PCSSCK(5U) | LPSPI_CCR_SCKDIV(5U) | LPSPI_CCR_DBT(0U)), /* ccr */
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_1_Instance_0 =
{
    0U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
             LPSPI_CFGR0_HRSEL(0U) | LPSPI_CFGR0_HRPOL(0U)), /* CFGR0 */
...
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_2 Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_2_Instance_4 =
{
    4U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
             LPSPI_CFGR0_HRSEL(0U) | LPSPI_CFGR0_HRPOL(0U)), /* CFGR0 */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_Instance_0 =
{
    0U,  /* Instance */
     /* CR */
    (uint32)0,
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_2_Instance_4 =
{
    4U,  /* Instance */
     /* CR */
    (uint32)0,
    ...
    #if (LPSPI_IP_DMA_USED == STD_ON)
    (boolean)TRUE,
    (uint8)5U, /* txDmaChannel */
    (uint8)6U, /* rxDmaChannel */
    #if (LPSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON)
    (uint8)0U, /* u8NumOfDmaFastTransfer */
    NULL_PTR, /* pCmdDmaFast */
    (uint8)0U,
