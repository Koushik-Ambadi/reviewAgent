...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration1[] = {
    {DMATCD0_IRQn, (boolean)TRUE, 15U, &Dma0_Ch0_IRQHandler},
    {DMATCD1_IRQn, (boolean)TRUE, 15U, &Dma0_Ch1_IRQHandler},
    {FlexCAN0_0_IRQn, (boolean)TRUE, 15U, &CAN0_ORED_IRQHandler},
    {FlexCAN0_1_IRQn, (boolean)TRUE, 15U, &CAN0_ORED_0_31_MB_IRQHandler},
    {FlexCAN0_2_IRQn, (boolean)TRUE, 15U, &CAN0_ORED_32_63_MB_IRQHandler},
    {FlexCAN0_3_IRQn, (boolean)TRUE, 15U, &CAN0_ORED_64_95_MB_IRQHandler},
    {FlexCAN3_0_IRQn, (boolean)TRUE, 15U, &CAN3_ORED_IRQHandler},
    {FlexCAN3_1_IRQn, (boolean)TRUE, 15U, &CAN3_ORED_0_31_MB_IRQHandler},
    {FlexCAN5_0_IRQn, (boolean)TRUE, 15U, &CAN5_ORED_IRQHandler},
    {FlexCAN5_1_IRQn, (boolean)TRUE, 15U, &CAN5_ORED_0_31_MB_IRQHandler},
    {SIUL_1_IRQn, (boolean)TRUE, 15U, &SIUL2_EXT_IRQ_8_15_ISR},
    {PIT0_IRQn, (boolean)TRUE, 15U, &PIT_0_ISR},
    {DMATCD2_IRQn, (boolean)TRUE, 15U, &Dma0_Ch2_IRQHandler},
    {DMATCD3_IRQn, (boolean)TRUE, 15U, &Dma0_Ch3_IRQHandler},
    {DMATCD16_IRQn, (boolean)TRUE, 15U, &Dma0_Ch16_IRQHandler},
    {DMATCD17_IRQn, (boolean)TRUE, 15U, &Dma0_Ch17_IRQHandler},
    {DMATCD18_IRQn, (boolean)TRUE, 15U, &Dma0_Ch18_IRQHandler},
    {SIUL_2_IRQn, (boolean)TRUE, 15U, &SIUL2_EXT_IRQ_24_31_ISR},
};
