...
#define RM_MSCM_IP_CFG_DEFINES_SW_MAJOR_VERSION                   6
...
#define MSCM_IP_SPI_MAX                             (223U)
/** @brief        Number of SPI Routing Support */
#define MSCM_IP_SPI_COUNT                           (159U)
...
#define MSCM_FLASH_0_PROGRAM_OR_ERASE_COMPLETED         (48U)
#define MSCM_FLASH_0_MAIN_WATCHDOG_TIMEOUT_INTERRUPT    (49U)
#define MSCM_FLASH_0_ALTERNATE_WATCHDOG_TIMEOUT_INTERRUPT (50U)
...
#define MSCM_SOC_FCCU_FAILURE_TO_REACT_INTERRUPT        (208U)
#define MSCM_SOC_FTCU_CRITICAL_FAILURE_INTERRUPT        (209U)
#define MSCM_SOC_RGM_FUNC_RESET_ESCALATION_INTERRUPT    (210U)
#define MSCM_SOC_CMU0_RESET_REACTION_INTERRUPT          (211U)
#define MSCM_SOC_PLL_LOL_INTERRUPT                      (212U)
#define MSCM_SOC_CORE_CLK_FAIL_REACT_INT                (213U)
#define MSCM_SOC_AIPS_PLAT_CLK_FAIL_REACT_INT           (215U)
#define MSCM_SOC_HSE_B_CLK_FAIL_REACT_INT               (217U)
#define MSCM_SOC_CGM_CLKDIV_FAILED                      (218U)
#define MSCM_SOC_HSE_TAMPER_INTERRUPT                   (220U)
#define MSCM_SOC_HSE_SNVS_TAMPER_INTERRUPT              (221U)
#define MSCM_SOC_MDM_DAP_DESTRUCTIVE_RESET_INTERRUPT    (222U)
#define MSCM_SOC_PIN_RESET_INTERRUPT                    (223U)
