...
#define PIT_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION_CFG     7
#define PIT_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION_CFG  0
#define PIT_IP_CFG_DEFINES_SW_MAJOR_VERSION_CFG             6
#define PIT_IP_CFG_DEFINES_SW_MINOR_VERSION_CFG             0
#define PIT_IP_CFG_DEFINES_SW_PATCH_VERSION_CFG             0
