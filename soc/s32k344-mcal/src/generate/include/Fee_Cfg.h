...
#define FEE_MINIMUM_READ_PAGE_SIZE               (8U)

/* Job end notification routine provided by the upper layer module (declaration) */
/** @implements   FeeNvmJobEndNotification_Object */
#define FEE_NVM_JOB_END_NOTIFICATION_DECL        extern void Fee_JobEndNotification_Abs(void);

/* Job end notification routine provided by the upper layer module */
/** @implements   FeeNvmJobEndNotification_Object */
#define FEE_NVM_JOB_END_NOTIFICATION             Fee_JobEndNotification_Abs();
...
#define FEE_NVM_JOB_ERROR_NOTIFICATION_DECL      extern void Fee_JobErrorNotification_Abs(void);

/* Job error notification routine provided by the upper layer module */
/** @implements   FeeNvmJobErrorNotification_Object */
#define FEE_NVM_JOB_ERROR_NOTIFICATION           Fee_JobErrorNotification_Abs();

/* Job cluster format notification routine provided by the upper layer module (declaration) */
#define FEE_NVM_CLUSTER_FORMAT_NOTIFICATION_DECL extern void Fee_ClusterFormatDuringInitNotification_Abs(void);

/* Job cluster format notification routine provided by the upper layer module */
#define FEE_NVM_CLUSTER_FORMAT_NOTIFICATION      Fee_ClusterFormatDuringInitNotification_Abs();
