...
extern void Canstk0_mb_rx_tx_callback(uint8 instance, Flexcan_Ip_EventType eventType,
                uint32 buffIdx, const Flexcan_Ip_StateType * flexcanState);
extern void Canstk0_error_callback(uint8 instance, Flexcan_Ip_EventType eventType,
                                            uint32 u32ErrStatus,
                                            const Flexcan_Ip_StateType * flexcanState);
extern void Canstk3_mb_rx_tx_callback(uint8 instance, Flexcan_Ip_EventType eventType,
                uint32 buffIdx, const Flexcan_Ip_StateType * flexcanState);
extern void Canstk3_error_callback(uint8 instance, Flexcan_Ip_EventType eventType,
                                            uint32 u32ErrStatus,
                                            const Flexcan_Ip_StateType * flexcanState);
extern void Canstk5_mb_rx_tx_callback(uint8 instance, Flexcan_Ip_EventType eventType,
                uint32 buffIdx, const Flexcan_Ip_StateType * flexcanState);
extern void Canstk5_error_callback(uint8 instance, Flexcan_Ip_EventType eventType,
                                            uint32 u32ErrStatus,
                                            const Flexcan_Ip_StateType * flexcanState);
...
const Flexcan_Ip_ConfigType FlexCAN_Config0  = {
  ...
  #endif
    /* Controller Callback */
    &Canstk0_mb_rx_tx_callback,
    /* Error Callback */
    &Canstk0_error_callback
    };
  ...
  #endif
    /* Controller Callback */
    &Canstk3_mb_rx_tx_callback,
    /* Error Callback */
    &Canstk3_error_callback
    };
  ...
  #endif
    /* Controller Callback */
    &Canstk5_mb_rx_tx_callback,
    /* Error Callback */
    &Canstk5_error_callback
    };
