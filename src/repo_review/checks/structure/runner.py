...
def run_validations(nodes, policy):
    ...
    issues.extend(validate_required_paths(nodes, policy))
    issues.extend(validate_forbidden_paths(nodes, policy))
    issues.extend(validate_allowed_extensions(nodes, policy))
    issues.extend(validate_forbidden_extensions(nodes, policy))
    issues.extend(validate_required_file_types(nodes, policy))
    issues.extend(validate_tree_rules(nodes, policy))
    issues.extend(validate_size_rules(nodes, policy))
